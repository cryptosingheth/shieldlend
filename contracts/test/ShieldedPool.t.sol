...
contract MockLendingPool {
    ...
    /// @dev Required by ShieldedPool._insert() — V2A cross-shard root registry.
    ...
    ///      Returns true when the mock has a non-zero owed amount (simulates an active loan).
...
contract ShieldedPoolTest is Test {
    ...
    function setUp() public {
        ...
        pool = new ShieldedPool(address(nullifierReg), address(zkVerify), VK_HASH, address(0));
